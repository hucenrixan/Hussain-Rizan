    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        <div class="max-w-3xl">
            ...
            <p class="text-base sm:text-lg md:text-xl text-gray-300 leading-relaxed mb-8 max-w-2xl">
                I help businesses grow by building web applications, mobile apps (iOS & Android), and custom software solutions tailored to their needs.
            </p>
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                ...
                <a href="portfolio.php" class="inline-flex items-center justify-center bg-white/10 backdrop-blur-md border-2 border-white/20 text-white px-5 sm:px-10 py-3.5 sm:py-5 rounded-2xl font-bold hover:bg-white/20 transition-all">
                    View My Work
                </a>
            </div>
            ...
            <div class="mt-8 sm:mt-10 grid grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 pt-6 border-t border-white/10">
                <div>
                    <p class="text-2xl sm:text-3xl font-black text-white">1+</p>
