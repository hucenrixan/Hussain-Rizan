<nav class="bg-white shadow-md sticky top-0 z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="portfolio.php" class="<?php echo $currentPage == 'portfolio' ? 'text-gray-900 font-semibold border-b-2 border-gray-900 py-1' : 'text-gray-600 hover:text-gray-900 transition'; ?>">Portfolio</a>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-gray-100 px-4 pt-2 pb-6 space-y-1 shadow-lg">
        ...
        <a href="portfolio.php" class="block px-3 py-2 rounded-md text-base font-medium <?php echo $currentPage == 'portfolio' ? 'bg-gray-100 text-gray-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'; ?>">Portfolio</a>
